...
namespace HiveEngineRenderer {
    ...
    TestDirective::TestDirective(Context *context) : Directive(context) {

    }

    void TestDirective::init_frame_buffers() {

        VkPipelineShaderStageCreateInfo vertShaderStageInfo = {};
        vertShaderStageInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
        vertShaderStageInfo.stage = VK_SHADER_STAGE_VERTEX_BIT;
        vertShaderStageInfo.module = get_context()->get_shaders()["test_shader.vert"];
        vertShaderStageInfo.pName = "main";

        VkPipelineShaderStageCreateInfo fragShaderStageInfo = {};
        fragShaderStageInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
        fragShaderStageInfo.stage = VK_SHADER_STAGE_FRAGMENT_BIT;
        fragShaderStageInfo.module = get_context()->get_shaders()["test_shader.frag"];
        ...
        if (vkCreatePipelineLayout(get_context()->get_device(), &pipelineLayoutInfo, nullptr, &pipelineLayout) != VK_SUCCESS) {
        ...
        for (size_t i = 0; i < get_context()->get_swap_chain_image_views().size(); i++) {
            ...
            if (vkCreateFramebuffer(get_context()->get_device(), &framebufferInfo, nullptr, &swapChainFramebuffers[i]) != VK_SUCCESS) {
        ...
        if (vkCreateGraphicsPipelines(get_context()->get_device(), VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &graphicsPipeline) != VK_SUCCESS) {
    ...
    void TestDirective::init_command_buffer() {
    ...
    std::vector<VkCommandBuffer> TestDirective::get_command_buffer() {
        return commandBuffers;
    }

    void TestDirective::cleanup() {
        for (auto framebuffer : swapChainFramebuffers) {
            vkDestroyFramebuffer(get_context()->get_device(), framebuffer, nullptr);
        }

        vkFreeCommandBuffers(get_context()->get_device(), get_context()->get_command_pool(), static_cast<uint32_t>(commandBuffers.size()), commandBuffers.data());
