...
#ifndef HIVEENGINE_NOISE_H
#define HIVEENGINE_NOISE_H
...
namespace HiveEngine {
    ...
    class NoiseSelector {
    public:
        std::vector<NoiseModule*> modules;

    };



    /*  libnoise, you are a life saver!
     *
     */
    ...
    float gradient_coherent_noise(glm::vec3 vertex, int seed);

    float gradient_noise(glm::vec3 f, glm::ivec3 i, int seed);

    float g_randomVectors[256 * 4] =
            {
